...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@osjwnpm/voluptatum-ipsam-eveniet">
    <img alt="" src="https://img.shields.io/npm/v/@osjwnpm/voluptatum-ipsam-eveniet.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@osjwnpm/voluptatum-ipsam-eveniet.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@osjwnpm/voluptatum-ipsam-eveniet">
...
There is also a [Changelog](https://github.com/osjwnpm/voluptatum-ipsam-eveniet/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@osjwnpm/voluptatum-ipsam-eveniet';
...
```js
const classNames = require('@osjwnpm/voluptatum-ipsam-eveniet/dedupe');
...
```js
const classNames = require('@osjwnpm/voluptatum-ipsam-eveniet/bind');
...
import classNames from '@osjwnpm/voluptatum-ipsam-eveniet/bind';
